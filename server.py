...
RESPONSE_FILE = os.path.join(TMP_DIR, "keropin_response.md")
EXPORT_FILE = os.path.join(TMP_DIR, "keropin_export.txt")
PID_FILE = os.path.join(TMP_DIR, "keropin_server.pid")
